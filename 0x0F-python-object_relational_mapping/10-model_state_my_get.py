...
It conects to a MySQL server running on localhost at port 3306 and retrieves
the State object with the given name.
Results display the states.id. If no state has the name you searched for,
display "Not found".
"""
